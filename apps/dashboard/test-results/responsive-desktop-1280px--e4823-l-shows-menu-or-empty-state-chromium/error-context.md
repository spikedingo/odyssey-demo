...
- Name: responsive.spec.ts >> desktop (1280px) >> POS terminal shows menu or empty state
- Location: e2e/responsive.spec.ts:28:9
...
Locator: getByText(/Self-Service Ordering|Cart \(|No menu yet|Failed to load/i)
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText(/Self-Service Ordering|Cart \(|No menu yet|Failed to load/i)
